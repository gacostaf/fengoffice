...
// Interface
    ...
    'start_date reminder notification task' => 'Start task reminder: {0}',
    'start_date task reminder desc' => 'The following task start date is {1} and is still pending: {0}',
    'start_date reminder notification milestone' => 'Start milestone reminder: {0}',
    'start_date milestone reminder desc' => 'The following milestone start date is {4} and is still pending:',
    ...
    'deleted notification task desc' => 'Task sent to the trash:',
    'deleted notification event' => 'Event sent to trash: {0}',
    'deleted notification event desc' => 'Event sent to the trash:',
    'deleted notification company' => 'Company sent to trash: {0}',
    'deleted notification company desc' => 'Company sent to the trash:',
    'deleted notification contact' => 'Individual contact object sent to trash: {0}',
    'deleted notification contact desc' => 'Individual contact object sent to trash:',
    'deleted notification message' => 'Note sent to trash: {0}',
    'deleted notification message desc' => 'Note sent to the trash:',
    'deleted notification file' => 'File sent to trash: {0}',
    'deleted notification file desc' => 'File sent to the trash:',
    'deleted notification webpage' => 'Link sent to trash: {0}',
    'deleted notification webpage desc' => 'Link sent to the trash:',
    'deleted notification weblink' => 'Link sent to trash: {0}',
    'deleted notification weblink desc' => 'Link sent to the trash:',
    'deleted notification milestone' => 'Milestone sent to trash: {0}',
    'deleted notification milestone desc' => 'Milestone sent to the trash:',
    'deleted notification email' => 'Email sent to trash: {0}',
    'deleted notification email desc' => 'Email sent to the trash:',
    'deleted notification mail' => 'Email sent to trash: {0}',
    'deleted notification mail desc' => 'Email sent to the trash:',
	...
	'unsubscribed notification task' => 'Unsubscribed to task: {0}',
	'unsubscribed notification task desc' => '{1} has unsubscribed you to the task:',
	'unsubscribed notification event' => 'Unsubscribed to event: {0}',
	'unsubscribed notification event desc' => '{1} has unsubscribed you to the event:',
	'unsubscribed notification company' => 'Unsubscribed to company: {0}',
	'unsubscribed notification company desc' => '{1} has unsubscribed you to the company:',
	'unsubscribed notification contact' => 'Unsubscribed to person: {0}',
	'unsubscribed notification contact desc' => '{1} has unsubscribed you to the person:',
	'unsubscribed notification message' => 'Unsubscribed to message: {0}',
	'unsubscribed notification message desc' => '{1} has unsubscribed you to the message:',
	'unsubscribed notification file' => 'Unsubscribed to file: {0}',
	'unsubscribed notification file desc' => '{1} has unsubscribed you to the file:',
	'unsubscribed notification webpage' => 'Unsubscribed to link: {0}',
	'unsubscribed notification webpage desc' => '{1} has unsubscribed you to the link:',
	'unsubscribed notification weblink' => 'Unsubscribed to link: {0}',
	'unsubscribed notification weblink desc' => '{1} has unsubscribed you to the link:',
	'unsubscribed notification milestone' => 'Unsubscribed to milestone: {0}',
	'unsubscribed notification milestone desc' => '{1} has unsubscribed you to the milestone:',
	'unsubscribed notification email' => 'Unsubscribed to email: {0}',
	'unsubscribed notification email desc' => '{1} has unsubscribed you to the email:',
