...
addLangs({
    ...
    'confirm delete time': 'Are you sure you want to delete the time entry?',
    ...
    'filter by cp': 'Filter by Custom Properties',
    ...
    'total worked time': 'Total worked time',
    ...
    'discard_work': 'Discard work on this task',
    'resume_work': 'Resume working on this task',
    'close work': 'Stop clock',
    'time worked': 'Time worked',
    'hours': 'hours',
    'complete this task': 'Complete this task',
    'mark as started this task': 'Mark this task as started',
    'unmark as started this task': 'Unmark this task as started',
    ...
    'error delete people parametric': 'You cannot move to trash Users \n{0}You may do this from the Administration Panel\n',
    'error delete company parametric': 'You cannot move to trash Companies \n{0}which contain Users or Contacts\n',
    ...
    'create email rule title': 'Create email rule',
    'quick edit': 'Quick edit',
    'quick mark as started': 'Quick mark as started',
    ...
    "the user assign to this task doesn't have permission over the selected project. The task is now unassigned": "The user assigned to this task has been removed since he/she doesn’t have permission for this classification",
    "the user assign to this timeslot doesn't have permission over the selected project. The timeslot is now unassigned": "The user assign to this time entry doesn't have permission over the selected project. The time entry is now unassigned",
    'This task has a parent with a quoted price. Estimated price will be set to zero.': 'This task has a parent with a quoted price. Estimated price will be set to zero.',
