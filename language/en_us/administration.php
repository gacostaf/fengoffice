<?php
  ...
  return array(
    ...
    'config option name use_task_work_performed' => 'Use time entries in tasks',
    'config option desc use_task_work_performed' => 'Allow users to create time entries inside tasks.',
    ...
    'config option desc show company logo in notifications' => 'The company logo is attached in the content of the notification.',
      ...
      'config option name notifications_add_members_in_subject' => 'Add object classification in subject for dimension',
	...
	'user config option desc mail_account_err_check_interval' => 'Time between each verification at email accounts (0 to disable)',
  	...
  	'user config option name descriptive_date_format' => 'Descriptive date format' ,
  	'user config option desc descriptive_date_format' => 'Template format to be applied to descriptive date values. Code explanations: d = Day number (2 digits with leading zeros), D = Day name (three letters), j = Day number, l = Complete day name, m = Month number (with leading zeros), M = Month name (three letters), n = Month number, F = Complete month name, Y = Year (4 digits), y = Year (2 digits). Refresh required.' ,
  	'user config option name add_timeslot_view_dimensions_combos' => 'Time entries classification',
  	'user config option desc add_timeslot_view_dimensions_combos' => 'In here you will be able to choose where will you be able to classify time entries',
    ...
    'user config option name close timeslot open' => 'Close the time entries that are still running when completing a task',  
    ...
    'can manage time' => 'Can manage time entries',
    'can add mail accounts' => 'Can add mail accounts',
    ...
    'can_see_others_timeslots'=>'Can see other user\'s time entries',
    ...
    'can_manage_time description' => 'If this permission is checked the user will have full permissions over time entries, being able to edit them even when the have not been created by himself.',
  ...
  'can_see_others_timeslots description'=> 'If enabled then the user will be able to see time entries that are not entered by him/her.',
  ...
  // END HIDDEN
    ...
    'user config option name pdf_page_layout' => 'Set default PDF page layout',
    'config_pdf_layout_portrait' => 'Vertical',
    'config_pdf_layout_landscape' => 'Landscape',

    'user config option name pdf_page_size' => 'Set default PDF page size',
    ...
    'member names desc' => 'In this section you can change the names of the members, leave blank the \'Custom name\' input to use the default name.',
	'default name' => 'Default name',
	'custom name' => 'Custom name',
	'custom name plural' => 'Custom name plural',
	...
	'user config option name enable_archive_confirmation' => 'Show confirmation dialog when archiving objects',
	'user config option name enable_trash_confirmation' => 'Show confirmation dialog when sending objects to trash',
    ...
    'user config option desc automatic_calculation_time'=>'When you change worked hours (or paused time) of a time tracking record, what do you prefer the system do?',
    ...
    'user config option name tasksGroupsPaginationCount' => 'Task groups per page',
    'user config option desc tasksGroupsPaginationCount' => 'Number of tasks groups to load in the tasks list when initializing and when loading more task groups.',
  		
  		'user config option name decimals_separator' => 'Decimals separator',
  		'user config option desc decimals_separator' => 'Symbol that seaparates the decimal digits in money amounts',
  		'user config option name thousand_separator' => 'Thousands separator',
