...
return array(
    ...
    'activity print' => "{1} printed {0} {2}",
    'activity mark_as_spam' => "{1} Marked as Spam {0} {2}",
    'activity unmark_as_spam' => "{1} Unmarked as Spam {0} {2}",
    'activity forward' => "{1} Forwarded {0} {2} with {3} {4}",
    'activity reply' => "{1} Replyed {0} {2} with {3} {4}",
    'activity reply_all' => "{1} Replyed to all {0} {2} with {3} {4}",
