...
return array(
    ...
    'activity print' => "{1} Imprimió {0} {2}",
    'activity mark_as_spam' => "{1} Marco como spam {0} {2}",
    'activity unmark_as_spam' => "{1} Desmarco como spam {0} {2}",
    'activity forward' => "{1} Reenvió {0} {2} con {3} {4}",
    'activity reply' => "{1} Respondió {0} {2} con {3} {4}",
    'activity reply_all' => "{1} Respondió a todos {0} {2} con {3} {4}",
