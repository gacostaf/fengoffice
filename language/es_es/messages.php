<?php return array(
    ...
    'success mark as started task' => 'La tarea seleccionada ha sido marcada como iniciada',
    'success unmark as started task' => 'La tarea seleccionada ha sido desmarcada como iniciada',    
	...
	'webpage dnx' => 'El enlace web requerido no existe en la base de datos',
	...
	'task x can be started' => 'Las tareas previas han sido completadas. Ya puede comenzar a trabajar en la tarea \'{0}\'.',
        ...
        'success created token' => 'Token creado correctamente',
        'success edited token' => 'Token editado correctamente',
        ...
        'config_dates_calc'=>'Mover la fecha opuesta (mantener las mismas horas ingresadas)',
        'config_hours_calc'=>'Modificar el tiempo trabajado',
        'always_show_modal'=>'Preguntarme cada vez',
        'How should we adjust'=>'¿Cómo debemos ajustarnos?',
        'Did you start sooner'=>'¿Empezaste antes?',
        'Did you end later'=>'¿Terminaste más tarde?',
        'You changed the length of your time record'=>'Has modificado la duración de tu registro de tiempo',
        'You changed a date in your time record'=>'Has modificado una fecha de tu registro de tiempo',
        'Did you start later'=>'¿Empezaste más tarde?',
        'Did you end sooner'=>'¿Terminaste antes?',
    
        'What do you prefer' => '¿Cómo prefieres?',
