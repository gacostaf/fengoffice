  ...
  abstract class BaseTabPanels extends DataManager {
    ...
    */
    static private $columns = array(
    	...
    	'refresh_on_context_change' => DATA_TYPE_BOOLEAN,
    	'default_controller' => DATA_TYPE_STRING,
    	'default_action' => DATA_TYPE_STRING,
    	'initial_controller' => DATA_TYPE_STRING,
    	'initial_action' => DATA_TYPE_STRING,
    ...
    * Construct
    *
    * @return BaseTabPanels 
    */
    function __construct() {
      parent::__construct('TabPanel', 'tab_panels', true);
    } // __construct
    ...
    */
    function find($arguments = null) {
      if(isset($this) && instance_of($this, 'TabPanels')) {
        ...
        return TabPanels::instance()->find($arguments);
      } // if
    } // find
    ...
    */
    function findById($id, $force_reload = false) {
      if(isset($this) && instance_of($this, 'TabPanels')) {
        ...
        return TabPanels::instance()->findById($id, $force_reload);
      } // if
    } // findById
    ...
    */
    function count($condition = null) {
      if(isset($this) && instance_of($this, 'TabPanels')) {
        ...
        return TabPanels::instance()->count($condition);
      } // if
    } // count
    ...
    */
    function delete($condition = null) {
      if(isset($this) && instance_of($this, 'TabPanels')) {
        ...
        return TabPanels::instance()->delete($condition);
      } // if
    } // delete
    ...
    */
    static function instance() {
      static $instance;
      if(!instance_of($instance, 'TabPanels')) {
        $instance = new TabPanels();
      } // if
      return $instance;
    } // instance
