<?php 
  ...
  /**
  * BaseContactDimensionPermissions class
  *
  * @author Diego Castiglioni <diego.castiglioni@fengoffice.com>
  */
  abstract class BaseContactDimensionPermissions extends DataManager {
    ...
    */
    static private $columns = array(
    	...
    	'permission_type' => DATA_TYPE_STRING
    );
  
    /**
    * Construct
    *
    * @return BaseContactDimensionPermissions 
    */
    function __construct() {
      parent::__construct('ContactDimensionPermission', 'contact_dimension_permissions', true);
    } // __construct
    ...
    */
    function getPkColumns() {
      return array ('permission_group_id', 'dimension_id');
    } // getPkColumns
    ...
    */
    function find($arguments = null) {
      if(isset($this) && instance_of($this, 'ContactDimensionPermissions')) {
        ...
        return ContactDimensionPermissions::instance()->find($arguments);
      } // if
    } // find
    ...
    */
    function count($condition = null) {
      if(isset($this) && instance_of($this, 'ContactDimensionPermissions')) {
        ...
        return ContactDimensionPermissions::instance()->count($condition);
      } // if
    } // count
  ...
  } // BaseContactDimensionPermissions 
