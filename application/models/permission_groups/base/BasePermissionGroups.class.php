<?php 
  ...
  /**
  * BasePermissionGroups class
  *
  * @author Diego Castiglioni <diego.castiglioni@fengoffice.com>
  */
  abstract class BasePermissionGroups extends DataManager {
    ...
    */
    function __construct() {
      parent::__construct('PermissionGroup', 'permission_groups', true);
    } // __construct
    ...
    */
    function count($condition = null) {
      if(isset($this) && instance_of($this, 'PermissionGroups')) {
        ...
        return PermissionGroups::instance()->count($condition);
      } // if
    } // count
