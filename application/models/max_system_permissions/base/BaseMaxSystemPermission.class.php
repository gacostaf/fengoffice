<?php
  ...
  /**
  * BaseMaxSystemPermission class
  *
  * @author Alvaro Torterola <alvaro.torterola@fengoffice.com>
  */
  abstract class BaseMaxSystemPermission extends DataObject {
    ...
    */
    function manager() {
      if(!($this->manager instanceof MaxSystemPermissions)) $this->manager = MaxSystemPermissions::instance();
      return $this->manager;
    } // manager
    ...
    function getCanManageRepetitivePropertiesOfTasks(){
        return $this->getColumnValue('can_manage_repetitive_properties_of_tasks');
    }
    
    function setCanManageRepetitivePropertiesOfTasks($value){
