  ...
  abstract class BaseBillings extends ContentDataObjects {
    ...
    */
    function __construct() {
    	Hook::fire('object_definition', 'Billing', self::$columns);
      parent::__construct('Billing', 'billings', true);
    } // __construct
    ...
    */
    function findAll($arguments = null) {
      if(isset($this) && instance_of($this, 'Billings')) {
        ...
        return Billings::instance()->findAll($arguments);
      } // if
    } // findAll
    ...
    */
    function findById($id, $force_reload = false) {
      if(isset($this) && instance_of($this, 'Billings')) {
        ...
        return Billings::instance()->findById($id, $force_reload);
      } // if
    } // findById
    ...
    */
    function count($condition = null) {
      if(isset($this) && instance_of($this, 'Billings')) {
        ...
        return Billings::instance()->count($condition);
      } // if
    } // count
    ...
    */
    function paginate($arguments = null, $items_per_page = 10, $current_page = 1, $count = null) {
      if(isset($this) && instance_of($this, 'Billings')) {
        ...
        return Billings::instance()->paginate($arguments, $items_per_page, $current_page);
      } // if
    } // paginate
