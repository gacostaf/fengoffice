<?php 
  ...
  /**
  * BaseDimensionObjectTypeHierarchies class
  *
  * @author Diego Castiglioni <diego.castiglioni@fengoffice.com>
  */
  abstract class BaseDimensionObjectTypeHierarchies extends DataManager {
    ...
    * Construct
    *
    * @return BaseDimensionObjectTypeHierarchies 
    */
    function __construct() {
      parent::__construct('DimensionObjectTypeHierarchy', 'dimension_object_type_hierarchies', true);
    } // __construct
    ...
    */
    function getPkColumns() {
      return array ('dimension_id', 'parent_object_type_id', 'child_object_type_id');
    } // getPkColumns
    ...
    */
    function find($arguments = null) {
      if(isset($this) && instance_of($this, 'DimensionObjectTypeHierarchies')) {
        ...
        return DimensionObjectTypeHierarchies::instance()->find($arguments);
      } // if
    } // find
    ...
    */
    function count($condition = null) {
      if(isset($this) && instance_of($this, 'DimensionObjectTypeHierarchies')) {
        ...
        return DimensionObjectTypeHierarchies::instance()->count($condition);
      } // if
    } // count
    ...
    */
    function delete($condition = null) {
      if(isset($this) && instance_of($this, 'DimensionObjectTypeHierarchies')) {
        ...
        return DimensionObjectTypeHierarchies::instance()->delete($condition);
      } // if
    } // delete
  ...
  } // BaseDimensionObjectTypeHierarchies 
