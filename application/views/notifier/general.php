...
<html xmlns="http://w3.org" >
	...
	<body style="margin:0; padding:0; background-color:#f4f4f4;">
		<div style="border: 2px solid #818283; width: 95%; font-family: Verdana, Arial, sans-serif; font-size: 12px; margin: 10px;">
		    <div>
		        <div>
		...
		<!--                    <img src="cid:<?php echo $attachments['logo']['cid']?>"/>-->
		            ...
		            <div style="width: 85%; float: left; font-size: 13px; margin-top: 10px; margin-bottom: 10px; margin-left: 10px; margin-right: 10px">
